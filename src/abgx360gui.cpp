...
void abgx360gui::CreateGUIControls()
{
	...
	CheckCorruption = new wxCheckBox(WxNoteBookPage_Options, ID_CHECKCORRUPTION, wxT("Check for AnyDVD style game data corruption"), wxPoint(202,16), wxSize(264,17), 0, wxDefaultValidator, wxT("CheckCorruption"));
	...
	RecurseSubdirs = new wxCheckBox(WxNoteBookPage_Options, ID_RECURSESUBDIRS, wxT("Recurse subdirectories when using Directory Input"), wxPoint(202,116), wxSize(287,17), 0, wxDefaultValidator, wxT("RecurseSubdirs"));
	RecurseSubdirs->SetFont(ABGX360GUI_FONT);

	CheckGameCRCWhenNeeded = new wxCheckBox(WxNoteBookPage_Options, ID_CHECKGAMECRCWHENNEEDED, wxT("Check Game Partition CRC when needed"), wxPoint(202,96), wxSize(236,17), 0, wxDefaultValidator, wxT("CheckGameCRCWhenNeeded"));
	...
	HideSecretAchievements = new wxCheckBox(WxNoteBookPage_Options, ID_HIDESECRETACHIEVEMENTS, wxT("Hide secret ones"), wxPoint(340,136), wxSize(109,17), 0, wxDefaultValidator, wxT("HideSecretAchievements"));
	...
	PatchIfStealthPasses = new wxCheckBox(WxNoteBookPage_ManualPatchExtract, ID_PATCHIFSTEALTHPASSES, wxT("Patch even if stealth passes"), wxPoint(5,16), wxSize(163,17), 0, wxDefaultValidator, wxT("PatchIfStealthPasses"));
	PatchIfStealthPasses->SetFont(ABGX360GUI_FONT);

	PatchIfInvalid = new wxCheckBox(WxNoteBookPage_ManualPatchExtract, ID_PATCHIFINVALID, wxT("Patch even if these files are invalid"), wxPoint(5,36), wxSize(208,17), 0, wxDefaultValidator, wxT("PatchIfInvalid"));
	...
	PatchVideoOpenButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_PATCHVIDEOOPENBUTTON, PatchVideoOpenButton_BITMAP, wxPoint(215,56), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("PatchVideoOpenButton"));
	...
	PatchPFIOpenButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_PATCHPFIOPENBUTTON, PatchPFIOpenButton_BITMAP, wxPoint(215,76), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("PatchPFIOpenButton"));
	...
	PatchDMIOpenButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_PATCHDMIOPENBUTTON, PatchDMIOpenButton_BITMAP, wxPoint(215,96), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("PatchDMIOpenButton"));
	...
	PatchSSOpenButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_PATCHSSOPENBUTTON, PatchSSOpenButton_BITMAP, wxPoint(215,116), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("PatchSSOpenButton"));
	PatchSSOpenButton->Enable(false);
	PatchSSOpenButton->SetFont(ABGX360GUI_FONT);

	WxStaticText2 = new wxStaticText(WxNoteBookPage_ManualPatchExtract, ID_WXSTATICTEXT2, wxT("Note: if you choose to both patch and extract files, extraction will be done first"), wxPoint(38,142), wxDefaultSize, 0, wxT("WxStaticText2"));
	...
	ExtractVideoSaveButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_EXTRACTVIDEOSAVEBUTTON, ExtractVideoSaveButton_BITMAP, wxPoint(462,36), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("ExtractVideoSaveButton"));
	ExtractVideoSaveButton->Enable(false);
	ExtractVideoSaveButton->SetFont(ABGX360GUI_FONT);

	ExtractEntireVideoPartition = new wxCheckBox(WxNoteBookPage_ManualPatchExtract, ID_EXTRACTENTIREVIDEOPARTITION, wxT("Extract entire video partition (253 MB)"), wxPoint(247,56), wxSize(222,17), 0, wxDefaultValidator, wxT("ExtractEntireVideoPartition"));
	...
	ExtractPFISaveButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_EXTRACTPFISAVEBUTTON, ExtractPFISaveButton_BITMAP, wxPoint(462,76), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("ExtractPFISaveButton"));
	...
	ExtractDMISaveButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_EXTRACTDMISAVEBUTTON, ExtractDMISaveButton_BITMAP, wxPoint(462,96), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("ExtractDMISaveButton"));
	...
	ExtractSSSaveButton = new wxBitmapButton(WxNoteBookPage_ManualPatchExtract, ID_EXTRACTSSSAVEBUTTON, ExtractSSSaveButton_BITMAP, wxPoint(462,116), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("ExtractSSSaveButton"));
	...
	FixBadAnglesValue = new wxChoice(WxNoteBookPage_AutoFix, ID_FIXBADANGLESVALUE, wxPoint(229,132), wxSize(46,23), arrayStringFor_FixBadAnglesValue, 0, wxDefaultValidator, wxT("FixBadAnglesValue"));
	...
	WxStaticText9 = new wxStaticText(WxNoteBookPage_Rebuilding, ID_WXSTATICTEXT9, wxT("Choose the method for rebuilding an ISO if it's missing space for a video partition."), wxPoint(10,16), wxDefaultSize, 0, wxT("WxStaticText9"));
	...
	KeepOriginalISO = new wxCheckBox(WxNoteBookPage_Rebuilding, ID_KEEPORIGINALISO, wxT("Don't delete the original ISO after rebuilding"), wxPoint(10,126), wxSize(254,17), 0, wxDefaultValidator, wxT("KeepOriginalISO"));
	...
	WxStaticText10 = new wxStaticText(WxNoteBookPage_Misc, ID_WXSTATICTEXT10, wxT("Add extra command line options here (for advanced users only):"), wxPoint(10,120), wxDefaultSize, 0, wxT("WxStaticText10"));
	...
	PreferredLangChoice = new wxChoice(WxNoteBookPage_Misc, ID_PREFERREDLANGCHOICE, wxPoint(122,39), wxSize(188,23), arrayStringFor_PreferredLangChoice, 0, wxDefaultValidator, wxT("PreferredLangChoice"));
	...
	dottedOpenButtonDisabled = new wxBitmapButton(Panel, ID_DOTTEDOPENBUTTONDISABLED, dottedOpenButtonDisabled_BITMAP, wxPoint(535,333), wxSize(24,16), wxBU_AUTODRAW, wxDefaultValidator, wxT("dottedOpenButtonDisabled"));
	...
	wxMenuItem * ID_MNU_MAKEADONATION_1868_mnuItem_obj = new wxMenuItem (ID_MNU_DONATE_1867_Mnu_Obj, ID_MNU_MAKEADONATION_1868, wxT("&Help support abgx360 development!"), wxT("Make a donation"), wxITEM_NORMAL);
	...
	wxMenuItem * ID_MNU_GOTOABGX360_NET_1869_mnuItem_obj = new wxMenuItem (ID_MNU_HELP_1669_Mnu_Obj, ID_MNU_GOTOABGX360_NET_1869, wxT("&http://abgx360.net"), wxT("Go to the official home of abgx360 to get the latest news and updates or join the chat for help"), wxITEM_NORMAL);
	...
	ID_MNU_HELP_1669_Mnu_Obj->Append(ID_MNU_WHERE_STEALTHFILES_1872, wxT("Where is my Stealth&Files folder...\tCtrl+F"), wxT("Find out where your StealthFiles are stored and automatically open the folder if you want."), wxITEM_NORMAL);
	ID_MNU_HELP_1669_Mnu_Obj->Append(ID_MNU_WHERE_IMAGES_1875, wxT("Where is my &Images folder...\tCtrl+I"), wxT("Find out where your Images are stored and automatically open the folder if you want."), wxITEM_NORMAL);
	ID_MNU_HELP_1669_Mnu_Obj->AppendSeparator();
	...
	SaveVideoFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("Video Files (*video*.iso)|*video*.iso|ISO Files (*.iso)|*.iso|All Files (*.*)|*.*"), wxFD_SAVE | wxFD_OVERWRITE_PROMPT);

	OpenVideoFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("Video Files (*video*.iso)|*video*.iso|ISO Files (*.iso)|*.iso|All Files (*.*)|*.*"), wxFD_OPEN | wxFD_FILE_MUST_EXIST);

	OpenFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("ISO/Stealth/Xex files (*.360, *.000, *.iso, *.bin, *.xex)|*.360;*.000;*.iso;*.bin;*.xex|ISO files (*.360, *.000, *.iso)|*.360;*.000;*.iso|Stealth Files (*.bin, *video*.iso)|*.bin;*video*.iso|Xex Files (*.xex)|*.xex|Video Files (*video*.iso)|*video*.iso|PFI Files (*pfi*.bin)|*pfi*.bin|DMI Files (*dmi*.bin)|*dmi*.bin|SS Files (*ss*.bin)|*ss*.bin|All Files (*)|*"), wxFD_OPEN | wxFD_FILE_MUST_EXIST | wxFD_MULTIPLE);
	...
	OpenSSFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("SS Files (*ss*.bin)|*ss*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_OPEN | wxFD_FILE_MUST_EXIST);

	OpenPFIFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("PFI Files (*pfi*.bin)|*pfi*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_OPEN | wxFD_FILE_MUST_EXIST);

	SaveDMIFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("DMI Files (*dmi*.bin)|*dmi*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
	...
	OpenDMIFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("DMI Files (*dmi*.bin)|*dmi*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_OPEN | wxFD_FILE_MUST_EXIST);

	SavePFIFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("PFI Files (*pfi*.bin)|*pfi*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
	...
	SaveSSFileDialog =  new wxFileDialog(this, wxT("Choose a file"), wxT(""), wxT(""), wxT("SS Files (*ss*.bin)|*ss*.bin|.bin Files (*.bin)|*.bin|All Files (*.*)|*.*"), wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
	...
	CheckDVDFileTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Checks that your ISO has a matching .dvd file with the correct layerbreak and iso filename and corrects it if not. If the .dvd file does not exist, it is created."), wxPoint(145,16), wxSize(16,16));
	CheckStealthTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Checks that your game appears to have a valid SS (which is required for it to boot on ANY firmware) and appears to have valid stealth files which match the Xex (which are required for it to boot on iXtreme firmware)."), wxPoint(100,36), wxSize(16,16));
	VerifyTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Verifies that your SS, stealth files and game data match a verified rip in the abgx360 online database. (Do not confuse this with the abgx.net database; that's just a database of scene releases and has nothing to do with verification.) In order for a rip to become verified in the abgx360 database there must be two different uploads from rips which match in every way except for the RawSS CRC (which changes every time you rip a disc due to angle deviation). Verification will fail if no one has uploaded rips which share your Xex/SS/DMI combination (which changes for discs pressed on different equipment and from different masters). It shouldn't worry you if verification fails on your own rip; in that case you should be fine as long as stealth passes, AnyDVD corruption is not detected and your system is stable. However, if you're checking someone else's rip that you don't fully trust then it's recommended to set AutoFix to Level 3, and if verification fails, abgx360 will attempt to find a new set of verified stealth files that match your Xex (and automatically patch them if found)."), wxPoint(143,56), wxSize(16,16));
	CheckVideoPaddingTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Checks that Video partitions are zero padded and pads them with zeros if not. This does not affect stealth and is most definitely a waste of time because whatever data is in the padding area is not even visible to the Xbox 360 host. So it doesn't matter if you enable this option or not, but you'll save some time if you leave it disabled. This should not be confused with the random padding check which is always performed on the game partition; that data IS visible to the Xbox 360 host and an ISO without random padding in the game partition will probably not even boot."), wxPoint(159,76), wxSize(16,16));
	CheckCorruptionTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Searches game data sectors for video files inserted by AnyDVD or any other application that does on-the-fly DVD copy protection removal. This check is performed automatically whenever the game CRC is checked so the only purpose of this option is to cause a game CRC check if nothing else did. See \"What is AnyDVD style corruption\" under the Quickstart tab for more info on game data corruption."), wxPoint(468,16), wxSize(16,16));
	CheckForUpdatesTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("\"Check for updates\" will check for updates to abgx360.dat, which contains things like the latest version available and the most current known PFI/Video wave exceptions. Disabling this option is not recommended because you won't be notified when a new version of abgx360 is available and abgx360 might not be using the latest list of PFI/Video exceptions." NEWLINE NEWLINE "The \"Include the CSV\" option will check for updates to GameNameLookup.csv, which is used to look up the full verbose game name entered in the online database. This isn't really necessary since abgx360 can retrieve the game name directly from the default.xex, but you may still find it useful when the Xex's game name is heavily abbreviated (developers can only use a maximum of 22 characters) or there's no title resource present, or maybe you're just checking SS/DMI files and would like to know which game they're from."), wxPoint(434,56), wxSize(16,16));
	GameCRCTip = new InfoTip(WxNoteBookPage_Options, InfoTip_BITMAP, wxT("Checks the game data CRC if a verified ini is found to make sure that your game data isn't corrupt. Disabling this option is not recommended. If you want the game CRC to be checked always, you should also enable the option \"Check for AnyDVD style game data corruption\", which will cause a game CRC check if nothing else did and will search for the obvious signs of AnyDVD style corruption. This is the only good reason why you'd want to check the game CRC always, but note that in order for other types of corruption to be detected (for example: single bit errors commonly caused by unstable CPU/RAM), a verified ini must be found."), wxPoint(439,96), wxSize(16,16));
	
	PatchIfStealthPassesTip = new InfoTip(WxNoteBookPage_ManualPatchExtract, InfoTip_BITMAP, wxT("The default behavior is to patch only if stealth fails and isn't AutoFixed, or stealth is uncertain and isn't verified/AutoFixed"), wxPoint(170,16), wxSize(16,16));
	
    AutoFixTip = new InfoTip(WxNoteBookPage_AutoFix, InfoTip_BITMAP, wxT("Choose the threshold at which abgx360 will attempt to find verified stealth files and automatically patch them if found. Level 1 or 2 is recommended for your own rips and Level 3 is recommended for someone else's rips that you don't fully trust."), wxPoint(463,15), wxSize(16,16));
    ...
    FixAngle359Tip = new InfoTip(WxNoteBookPage_AutoFix, InfoTip_BITMAP, wxT("iXtreme versions previous to v1.4 have a bug that will cause a valid angle of 359 degrees to be jittered to an invalid angle of 360 degrees (NOT safe for XBL). It is recommended to upgrade your firmware to the latest iXtreme version to fix this issue instead of relying on this option, but enabling it will adjust 359 to 0 for compatibility with older firmwares. Also note that enabling this option is harmless on newer firmwares (iXtreme v1.4 and later) as it merely changes the SS v1 angle deviation by 1 degree."), wxPoint(251,95), wxSize(16,16));
	FixDRTTip = new InfoTip(WxNoteBookPage_AutoFix, InfoTip_BITMAP, wxT("abgx360 decrypts the host's CCRT (Crypted Challenge Response Table) and combines it with the drive's deobfuscated table in order to validate or invalidate the data stored in an additional table used by hacked firmwares to replay responses to challenges issued by the host. Some invalid conditions can't or shouldn't be fixed, but enabling this option will fix the most common conditions like missing C/R data caused by old buggy ripping firmwares or worn out drives. This data is always checked whether this option is enabled or not and an error message will appear if any data is missing or invalid. This option applies to SS v1 only and has no effect on SS v2."), wxPoint(193,115), wxSize(16,16));
	FixBadAnglesTip = new InfoTip(WxNoteBookPage_AutoFix, InfoTip_BITMAP, wxT("Enabling this option will adjust the replay angles for Challenge Types 24 and 25 (Response Types 7 and 5) back to their CCRT targets if they deviate more than X degrees (default = 3). See \"Angle Deviation and You\" under the Quickstart tab for more on this. Deviation is always checked whether this option is enabled or not and a warning message will appear if any angle deviates more than 3 degrees (message is yellow - stealth is uncertain) or 9 degrees (message is red - stealth failed). This option applies to SS v1 only and has no effect on SS v2."), wxPoint(455,135), wxSize(16,16));
	...
	RebuildLowSpaceTip = new InfoTip(WxNoteBookPage_Rebuilding, InfoTip_BITMAP, wxT("Only requires 253 MB free space but will corrupt your ISO if it fails during the rebuilding process."), wxPoint(159,70), wxSize(16,16));
	
	MyRegionTip = new InfoTip(WxNoteBookPage_Misc, InfoTip_BITMAP, wxT("Optionally enter your console's region so abgx360 can display your game's region code in the appropriate color. If a game won't work on your console, the region code will be displayed in red so you won't overlook it and accidentally burn it. You can select multiple regions if you have multiple consoles."), wxPoint(328,16), wxSize(16,16));
...
void abgx360gui::UIUpdate(wxUpdateUIEvent& WXUNUSED(event))
{
    ...
    if (InputChoice->GetCurrentSelection() == 0) {  // file(s)
        ...
        if (!InputFileEditBox->GetValue().StartsWith(wxT("\""), NULL)) cmd += wxT("\"");
        cmd += InputFileEditBox->GetValue();
        if (InputFileEditBox->GetValue().EndsWith(wxT("\\"), NULL)) cmd += wxT("\\\""); // asdf\ will be changed to asdf\\ so the shell sees it as asdf\ instead of asdf" ("asdf\" vs "asdf\\" when quoted by app)
	...
	if (str.Len()) {
        for (i=0;i<aMatches.GetCount();i++) {
            if (str.Find(aMatches.Item(i)) == 0 ||
                ...
                str.Find(wxT(", ")+aMatches.Item(i)) != wxNOT_FOUND) aMatchSelections.Add(i);
        }
    }
