...
class abgx360gui : public wxFrame
{
	...
	public:
		abgx360gui(wxWindow *parent, wxWindowID id = 1, const wxString &title = wxT("abgx360gui"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = abgx360gui_STYLE);
		virtual ~abgx360gui();
	...
	private:
		...
		wxPanel *WxNoteBookPage_ManualPatchExtract;
		...
		wxPanel *WxNoteBookPage_Options;
		...
		InfoTip *MyRegionTip, *RebuildDefaultTip, *RebuildLowSpaceTip,
                *AutoFixTip, *TrustSSv2Tip, *FixDRTTip, *FixAngle359Tip,
                *FixBadAnglesTip, *PatchIfStealthPassesTip, *CheckDVDFileTip,
                *CheckStealthTip, *VerifyTip, *CheckVideoPaddingTip,
                *CheckCorruptionTip, *CheckForUpdatesTip, *GameCRCTip, *SplitVidTip,
                *ImagesTip, *PreferredLangTip;
